...
[My website/blog](https://taylor.gl) is a Phoenix application, which uses `esbuild`, and `tailwindcss` for styling, as per [this guide](https://pragmaticstudio.com/tutorials/adding-tailwind-css-to-phoenix). It has an RSS feed and supports auto-discovery.
...
## Images
As a convenience feature, images are displayed upside-down for users in Australia.
